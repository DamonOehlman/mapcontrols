MapControls.register('zoom', function(helpers, opts) {
    ...
    var zoombar = MapControls._createEl('div', { className: opts.className });
    
    // add the zoom out button
    zoombar.appendChild(MapControls._createEl('div', {
        className: genClasses('zoom', 'zoom-out')
    }));
    ...
    zoombar.appendChild(MapControls._createEl('div', {
        className: genClasses('zoom', 'zoom-in')
    }));
